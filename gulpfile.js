...
// TASKS
export { clean, html, styles, scripts, images, fonts, server };
...
// BUILD TASK
export const build = gulp.series(clean, gulp.parallel(html, styles, scripts), gulp.parallel(fonts, images));

// DEV TASK
export const dev = gulp.series(build, gulp.parallel(server, watching));
